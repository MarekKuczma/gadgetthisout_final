...
<head>
  ...
  <link rel="stylesheet" href="css/styles_two.css">
  ...
  <div class="content">
        ...
        <p class="listing margin_bottom">Well, here's a little list :</p>
  		...
  		<div class="row">
            ...
            <h1 class="column_title">You can take this accessories</h1>
            <p class="accesories_small">*Get one or both, they will be added to your bill</p>
            <div class="row no_margin">

              <div class="accesories_column click_one">
                <div class="accesories_selected selected_one"></div>
                <p class="accesories">Pluvio<br><span class="color">70euro</span></p>
                <img class="small_accesories" src="photos/netatmo/pluvio.png" alt="netatmo pluvio">
              </div>

              <div class="accesories_column click_two margin_left_24">
                <div class="accesories_selected selected_two"></div>
                <p class="accesories">Additional Module<br><span class="color">70euro</span></p>
                <img class="small_accesories" src="photos/netatmo/module.png" alt="netatmo module 2">
              </div>

            </div>
	  				<h2 class="column_title margin_top_48">And just</h2>
	  				<a href="thanks.php" class="big_button">grab your gadget</a>
